...
for file in os.listdir(input_dir):
    if file.endswith(".obj"):
        ...
        linestyle.use_length_min = True
        linestyle.length_min = 20.0
        linestyle.chaining = "SKETCHY"
        linestyle.use_split_length = True
        linestyle.split_length = 100.0
        
        linestyle.thickness = 1.0
        bpy.ops.scene.freestyle_thickness_modifier_add(type='ALONG_STROKE')

        #geometry
        bpy.ops.scene.freestyle_geometry_modifier_add(type='TIP_REMOVER')
        linestyle.geometry_modifiers["Tip Remover"].tip_length = 4.0
        ...
        linestyle.geometry_modifiers["Spatial Noise"].amplitude = 1.5
